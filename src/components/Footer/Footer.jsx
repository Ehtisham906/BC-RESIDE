...
export default function Footer() {
    return (
        <footer className="bg-[#B6C9C9] mt-6">
            <div className="flex justify-between " >
                <div style={{ width: "33%" }} className="logofooter">
                    <img src={logo} alt="bcreside-logo" style={{ width: "50%" }} />
                </div>

                <div style={{ width: "33%" }} className=" flex flex-col gap-10">
                    <div className="flex">
                        <div>
                        ...
                        <div>
                            ...
                            <span>+1 236 972 8267</span>
                        </div>
                    </div>
                    <div className="flex">
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M12 2C8.13 2 5 5.13 5 9C5 14.25 12 22 12 22C12 22 19 14.25 19 9C19 5.13 15.87 2 12 2ZM12 11.5C10.62 11.5 9.5 10.38 9.5 9C9.5 7.62 10.62 6.5 12 6.5C13.38 6.5 14.5 7.62 14.5 9C14.5 10.38 13.38 11.5 12 11.5Z" fill="#202124" />
                            </svg>
                        </div>
                        <div>

                            <span>147 Wyndham St N Guelph, Ontario N1H 5F9</span>
                        </div>
                    </div>
                    <div className="flex">
                        <div>
                        ...
                        <div>
                            ...
                            <span>real-estate@bcreside.com</span>
                        </div>
                    </div>

                </div>
                <div style={{ width: "33%" }} className="flex  justify-center mx ">
